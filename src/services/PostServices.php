...
class PostServices
{
    ...
    public function displaySingleHomepage(PostsEntity $post):string{
        $outcome = '';
...
public function displayHomepage(array $posts):string{

    $outcome = "<section class='container lg:w-1/2 mx-auto flex flex-col gap-5'>";

     foreach ($posts as $post){
         $outcome .= $this->displaySingleHomepage($post);
     }
