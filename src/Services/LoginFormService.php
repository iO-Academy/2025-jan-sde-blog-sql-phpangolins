...
//{
//    static public function displayLoginForm($user)
//    {
...
//        $output .= LoginFormService::displayError($user);
//        $output .= ' </div>';
...
//    }
//
//    static public function displayError($user): string | false
//    {
//        if ($user->checkUser() === false) {
//            return '<p>Email or password are incorrect</p>';
//        }
//        return false;
//    }
//}
